	...
	if (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post'])))
	{
		...
		elseif (!empty($context['latest_posts']))
		{
			...
			foreach ($context['latest_posts'] as $post)
			{
				echo '
				    <tr class="windowbg"> 
					    <td width="50%">', $post['link'], '<br/>', $txt['by'], ' ', $post['poster']['link'], '</td>
					    <td width="25%"><img src="' . $settings['images_url'] .'/normal_post.gif" alt="" width="20" height="20" style="margin-bottom: -4px" /> ', $post['board']['link'], '</td>
					    <td width="25%"><img src="' . $settings['images_url'] .'/clock-frame.png" alt="" width="16" height="16" style="margin-bottom: -4px" /> ', $post['time'], '</td>
				    </tr>';
			}
			echo '
				</table>';
