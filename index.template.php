...
function template_body_below()
{
	...
	<div id="wrapper2">
		<div class="footer_section"><div class="wrapper">
			...
			', !empty($settings['sh_custom_message']) ? $settings['sh_custom_message'] : $txt['sh_custom_message_default'], '
			...
			<div class="floatright">
				...
				<ul class="reset" style="text-align: right;">
					...
					<li class="copyright">', theme_st(), '</li>
				</ul>
			</div>
						...
						<div id="loginForm">
							<fieldset id="body">
									<fieldset>';
										...
										{
										echo '
											<a href="', $scripturl, '?action=profile"><img class="ava_bar floatleft" src="', $context['user']['avatar']['href'], '" alt="" /></a>';
										}
										else {
										echo '
											<a href="', $scripturl, '?action=profile"><img class="ava_bar floatleft" src="', $settings['images_url'], '/default_avatar.png" alt="" /></a>';
										}
											
										echo '
											<ul class="reset" style="float: right;">
									...
									<fieldset>
										<div id="login_area">
											<form id="guest_form" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
												<input type="password" name="passwrd" value="', $txt['password'], '" onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['password'], '\';" class="placeholder password" />
												<input type="text" name="user" value="', $txt['username'], '" onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['username'], '\';" class="placeholder user" /><br />
												<input type="submit" value="', $txt['login'], '" class="button_login" />
